...
// class WorkloadSummary extends Component {
//   constructor(props) {
//     super(props);
//     this.state = {
//       uploadedFiles: [], // Initial state for uploaded files
//     };


//     this.workloadId = props.match.params.workloadId; // Ensure you have this in your route
//     console.log('workloadId', this.workloadId);
//   }

//   handleFileUpload = (event) => {
//     const files = Array.from(event.target.files);
//     this.setState((prevState) => ({
//       uploadedFiles: [...prevState.uploadedFiles, ...files], // Update the uploadedFiles state
//     }));
//   };

//   render() {
//     const { uploadedFiles } = this.state; // Destructuring state
    
//     return (
//       <div className="p-8 space-y-8">
//         {/* Header with Tabs */}
//         <div className="flex justify-between items-center mb-6">
//           <h1 className="text-2xl font-bold">45sdf28d</h1>
...
//             <Link to={`${APP_PREFIX_PATH}/wafr/assignment/${this.workloadId}`}>
