...
//   return (
//     <div className="p-1">
//       <TableContainer className="shadow-lg h-80">
//         <Table>
//           <TableHead>
//             <TableRow>
//               <TableCell className="font-bold"   sx={{color: '#383874',}}>TIMESTAMP</TableCell>
//               <TableCell className="font-bold "   sx={{color: '#383874'}}>USER NAME</TableCell>
//               <TableCell className="font-bold "   sx={{color: '#383874'}}>EVENT NAME</TableCell>
//               <TableCell className="font-bold "   sx={{color: '#383874'}}>DESCRIPTION</TableCell>
//             </TableRow>
//           </TableHead>
//           <TableBody>
//             {data.map((row, index) => (
//               <TableRow key={index}>
//                 <TableCell sx={{color: '#383874'}} >{row.timestamp}</TableCell>
//                 <TableCell sx={{color: '#383874'}} >{row.userName}</TableCell>
//                 <TableCell sx={{color: '#383874'}} >{row.eventName}</TableCell>
//                 <TableCell  sx={{color: '#383874'}}>{row.description}</TableCell>
//               </TableRow>
//             ))}
//           </TableBody>
//         </Table>
